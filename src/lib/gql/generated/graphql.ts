...
export type FirstSpiritGlobalTranslation = {
  ...
  items?: Maybe<Array<Maybe<FirstSpiritDataset>>>;
...
export type FirstSpiritInlineDatasetUnionB50D929C =
  | FirstSpiritGlobalTranslation
  | FirstSpiritRequests
  | FirstSpiritSmartlivingAuthor
  | FirstSpiritSmartlivingCategory
  | FirstSpiritSmartlivingLocation
  | FirstSpiritSmartlivingNews
  | FirstSpiritSmartlivingProduct
  | FirstSpiritSmartlivingProductOverview
  | FirstSpiritSmartlivingTag
  | FirstSpiritTask;

export type FirstSpiritInlineGcaPageUnion22228A32 =
  | FirstSpiritFtsGcaMapping
  | FirstSpiritGcaFooter
  | FirstSpiritHomepage
  | FirstSpiritLocationsJson
  | FirstSpiritMetadata
  | FirstSpiritMpp
  | FirstSpiritNewsJson
  | FirstSpiritProjectSettings
  | FirstSpiritRedirects
  | FirstSpiritStandard
  | FirstSpiritTranslationstudioConfiguration;

export type FirstSpiritInlinePageUnion8F4Ef8C0 =
  | FirstSpiritFtsGcaMapping
  | FirstSpiritGcaFooter
  | FirstSpiritHomepage
  | FirstSpiritLocationsJson
...
export type FirstSpiritInlineSectionUnion638Da777 =
  | FirstSpiritAccordion
  | FirstSpiritAccordionItem
  | FirstSpiritDatasetLink
  | FirstSpiritExternalLink
  | FirstSpiritFeature
  | FirstSpiritFeatures
  | FirstSpiritFscataloglinktest
  | FirstSpiritFscatalogsectiontest
  | FirstSpiritFsdatasettest
  | FirstSpiritFsindex
  | FirstSpiritFsrefeferencepage
  | FirstSpiritFsreferencedataset
  | FirstSpiritFsreferencepicture
  | FirstSpiritFsreferencfile
  | FirstSpiritFtsLanguageMapping
  | FirstSpiritFtsMultiplePageEntry
  | FirstSpiritGlobalTranslation
  | FirstSpiritGoogleMaps
  | FirstSpiritInteractiveImage
  | FirstSpiritInteractiveImageLink
  | FirstSpiritInternalLink
  | FirstSpiritLatestNews
  | FirstSpiritLocation
...
export type FirstSpiritLinkUnion =
  | FirstSpiritDatasetLink
  | FirstSpiritExternalLink
  | FirstSpiritInteractiveImageLink
  | FirstSpiritInternalLink
...
export type FirstSpiritOptionSortInput = {
  items?: InputMaybe<FirstSpiritDatasetSortInput>;
...
export type FirstSpiritPageBodyContent =
  | FirstSpiritContent2Section
  | FirstSpiritDataset
  | FirstSpiritSection;
...
export type FirstSpiritReferenceUnion =
  | FirstSpiritDatasetValue
  | FirstSpiritFile
  | FirstSpiritImage
  | FirstSpiritPageRef
  | FirstSpiritReference;
...
export type FirstSpiritSmartlivingProduct = {
  ...
  items?: Maybe<Array<Maybe<FirstSpiritDataset>>>;
  ttCategories?: Maybe<Array<Maybe<FirstSpiritDataset>>>;
  ttDescription?: Maybe<Scalars["JSON"]["output"]>;
  ttImage?: Maybe<FirstSpiritReferenceUnion>;
  ttImageAltText?: Maybe<Scalars["String"]["output"]>;
  ttName?: Maybe<Scalars["String"]["output"]>;
...
export type DatasetsByTypeQuery = {
  __typename?: "Query";
  allFirstSpiritDataset: {
    ...
    nodes: Array<{
      ...
      data:
        ...
        | ({ __typename: "FirstSpiritSmartlivingLocation" } & {
            " $fragmentRefs"?: {
              FirstSpiritSmartLivingLocationFragmentFragment: FirstSpiritSmartLivingLocationFragmentFragment;
            };
          })
        | ({ __typename: "FirstSpiritSmartlivingNews" } & {
            " $fragmentRefs"?: {
              FirstSpiritSmartLivingNewsFragmentFragment: FirstSpiritSmartLivingNewsFragmentFragment;
            };
          })
        | { __typename: "FirstSpiritSmartlivingProduct" }
        | { __typename: "FirstSpiritSmartlivingProductOverview" }
...
export type FirstSpiritTeaserFragmentFragment = {
  __typename?: "FirstSpiritTeaser";
  stHeadline?: string | null;
  stText?: any | null;
  stImageAltText?: string | null;
  stImage?:
    | { __typename: "FirstSpiritDatasetValue" }
    | { __typename: "FirstSpiritFile" }
    | {
        ...
        resolutions?: {
          __typename?: "FirstSpiritResolution";
          original?: { __typename?: "FirstSpiritResolutionProps"; url: string } | null;
        } | null;
      }
    | { __typename: "FirstSpiritPageRef" }
    | { __typename: "FirstSpiritReference" }
...
} & { " $fragmentName"?: "FirstSpiritTeaserFragmentFragment" };

export type FirstSpiritStageFragmentFragment = {
  __typename?: "FirstSpiritStage";
  stHeadline?: string | null;
  stSubHeadlineTextImageStage?: string | null;
  stImage?:
    | { __typename: "FirstSpiritDatasetValue" }
    | { __typename: "FirstSpiritFile" }
    | {
    ...
    data?:
      ...
      | {
          ...
          ltLink?:
            ...
            | {
                __typename: "FirstSpiritPageRef";
                page?: { __typename?: "FirstSpiritPage"; route?: string | null } | null;
              }
            | { __typename: "FirstSpiritReference" }
            | null;
        }
...
} & { " $fragmentName"?: "FirstSpiritStageFragmentFragment" };

export type FirstSpiritTextImageFragmentFragment = {
  __typename?: "FirstSpiritTextImage";
  stHeadline?: string | null;
  stText?: any | null;
  stSubHeadlineTextImage?: any | null;
  stColumns?: { __typename?: "FirstSpiritOption"; key?: string | null } | null;
  stLayout?: { __typename?: "FirstSpiritOption"; key?: string | null } | null;
  stImage?:
    | { __typename: "FirstSpiritDatasetValue" }
    | { __typename: "FirstSpiritFile" }
    | {
    ...
    | { __typename: "FirstSpiritReference" }
    | null;
} & { " $fragmentName"?: "FirstSpiritTextImageFragmentFragment" };

export type FirstSpiritProductCategoryTeaserFragmentFragment = {
  __typename?: "FirstSpiritProductCategoryTeaser";
  stHeadline?: string | null;
  stText?: any | null;
  stTextAlignment?: { __typename?: "FirstSpiritOption"; key?: string | null } | null;
  stCategoryLink?: {
    __typename?: "FirstSpiritLink";
    data?:
      | { __typename: "FirstSpiritDatasetLink" }
            ...
            items?: Array<{
              ...
              data:
                ...
                | {
                    ...
                    ttName?: string | null;
                    ttPrice?: string | null;
                    ttDescription?: any | null;
                    ttImageAltText?: string | null;
                    ttImage?:
                      | { __typename: "FirstSpiritDatasetValue" }
                      | { __typename: "FirstSpiritFile" }
                      | {
                    ...
                    ttCategories?: Array<{
                      ...
                      data:
                        ...
                        | { __typename: "FirstSpiritRequests" }
                        | { __typename: "FirstSpiritSmartlivingAuthor" }
                        | { __typename: "FirstSpiritSmartlivingCategory"; ttName?: string | null }
                        | { __typename: "FirstSpiritSmartlivingLocation" }
                        | { __typename: "FirstSpiritSmartlivingNews" }
                        | { __typename: "FirstSpiritSmartlivingProduct" }
                        | { __typename: "FirstSpiritSmartlivingProductOverview" }
...
} & { " $fragmentName"?: "FirstSpiritProductCategoryTeaserFragmentFragment" };

export type FirstSpiritStepsFragmentFragment = {
  __typename?: "FirstSpiritSteps";
  stHeadline?: string | null;
  stSubline?: string | null;
  stText?: any | null;
  stSteps?: Array<{
    __typename: "FirstSpiritSection";
    data:
      ...
      | { __typename: "FirstSpiritStage" }
      | { __typename: "FirstSpiritSteps" }
      | { __typename: "FirstSpiritStepsItem"; stTitle?: string | null; stText?: any | null }
      | { __typename: "FirstSpiritTable" }
      | { __typename: "FirstSpiritTask" }
      | { __typename: "FirstSpiritTeaser" }
      | { __typename: "FirstSpiritTextImage" };
  } | null> | null;
} & { " $fragmentName"?: "FirstSpiritStepsFragmentFragment" };

export type FirstSpiritAccordionFragmentFragment = {
  __typename?: "FirstSpiritAccordion";
  stHeadline?: string | null;
  stSubline?: string | null;
  stInfo?: any | null;
  stAccordion?: Array<{
    ...
    data:
      | { __typename: "FirstSpiritAccordion" }
      | { __typename: "FirstSpiritAccordionItem"; stTitle?: string | null; stContent?: any | null }
      | { __typename: "FirstSpiritDatasetLink" }
      | { __typename: "FirstSpiritExternalLink" }
      | { __typename: "FirstSpiritFeature" }
      | { __typename: "FirstSpiritFeatures" }
...
} & { " $fragmentName"?: "FirstSpiritAccordionFragmentFragment" };

export type FirstSpiritFeaturesFragmentFragment = {
  __typename?: "FirstSpiritFeatures";
  stHeadline?: string | null;
  stText?: any | null;
  stFeatures?: Array<{
    ...
    data:
      ...
      | {
          ...
          stText?: any | null;
          stImageAltText?: string | null;
          stType?: { __typename?: "FirstSpiritOption"; key?: string | null } | null;
          stLink?: {
            __typename?: "FirstSpiritLink";
            data?:
              | { __typename: "FirstSpiritDatasetLink" }
...
} & { " $fragmentName"?: "FirstSpiritFeaturesFragmentFragment" };

export type FirstSpiritGoogleMapsFragmentFragment = {
  __typename?: "FirstSpiritGoogleMaps";
  stHeadline?: string | null;
  stSubheadline?: string | null;
  stInitialZoom?: number | null;
  stInitialLat?: number | null;
  stInitialLong?: number | null;
} & { " $fragmentName"?: "FirstSpiritGoogleMapsFragmentFragment" };

export type FirstSpiritNewsOverviewFragmentFragment = {
  __typename?: "FirstSpiritNewsOverview";
  stHeadline?: string | null;
  stDataPage?:
    | { __typename: "FirstSpiritDatasetValue" }
    ...
    | {
        ...
        page?: { __typename?: "FirstSpiritPage"; fsId: string } | null;
      }
    | { __typename: "FirstSpiritReference" }
    | null;
} & { " $fragmentName"?: "FirstSpiritNewsOverviewFragmentFragment" };

export type FirstSpiritSmartLivingNewsFragmentFragment = {
  __typename?: "FirstSpiritSmartlivingNews";
  ttHeadline?: string | null;
  ttSubheadline?: string | null;
  ttDate?: any | null;
  ttAuthor?: any | null;
  ttTags?: any | null;
  ttImageAltText?: string | null;
  ttTeaserText?: string | null;
  ttArticleText?: any | null;
  ttImage?:
    | { __typename: "FirstSpiritDatasetValue" }
    | { __typename: "FirstSpiritFile" }
    | {
    ...
    | { __typename: "FirstSpiritReference" }
    | null;
} & { " $fragmentName"?: "FirstSpiritSmartLivingNewsFragmentFragment" };

export type FirstSpiritSmartLivingLocationFragmentFragment = {
  __typename?: "FirstSpiritSmartlivingLocation";
  ttName?: string | null;
  ttDescription?: any | null;
  ttLat?: number | null;
  ttLong?: number | null;
} & { " $fragmentName"?: "FirstSpiritSmartLivingLocationFragmentFragment" };

export type FirstSpiritTableFragmentFragment = {
  __typename?: "FirstSpiritTable";
  stHeadline?: string | null;
  stText?: any | null;
  stTable?: any | null;
} & { " $fragmentName"?: "FirstSpiritTableFragmentFragment" };
...
export type GcaPageByNameQuery = {
  __typename?: "Query";
  firstSpiritGcaPage?: {
    __typename?: "FirstSpiritGcaPage";
    data:
...
export type FsNavigationQueryQuery = {
  __typename?: "Query";
  firstSpiritNavigationData?: {
    ...
    structure: Array<{
      ...
      navigationItem: {
        __typename?: "FirstSpiritNavigationItem";
        label?: string | null;
        seoRoute?: string | null;
        fsNavItemId: string;
        page?: { __typename?: "FirstSpiritPage"; id: string } | null;
      };
      structureChildren: Array<{
        __typename?: "FirstSpiritStructureItem";
        navigationItem: {
          __typename?: "FirstSpiritNavigationItem";
          label?: string | null;
...
export type PageByRouteQuery = {
  ...
  firstSpiritPage?: {
    ...
    data:
      ...
      | {
          __typename: "FirstSpiritStandard";
          ptHeadline?: string | null;
          ptSubheadline?: string | null;
          ptMdImageAltText?: string | null;
          ptImage?:
            | { __typename: "FirstSpiritDatasetValue" }
            | { __typename: "FirstSpiritFile" }
            | {
      ...
      children?: Array<
        ...
        | {
            ...
            data:
              | ({ __typename: "FirstSpiritAccordion" } & {
                  " $fragmentRefs"?: {
                    FirstSpiritAccordionFragmentFragment: FirstSpiritAccordionFragmentFragment;
                  };
                })
              | { __typename: "FirstSpiritAccordionItem" }
              | { __typename: "FirstSpiritDatasetLink" }
              ...
              | ({ __typename: "FirstSpiritFeatures" } & {
                  " $fragmentRefs"?: {
                    FirstSpiritFeaturesFragmentFragment: FirstSpiritFeaturesFragmentFragment;
                  };
                })
              | { __typename: "FirstSpiritFscataloglinktest" }
              | { __typename: "FirstSpiritFscatalogsectiontest" }
              ...
              | ({ __typename: "FirstSpiritGoogleMaps" } & {
                  " $fragmentRefs"?: {
                    FirstSpiritGoogleMapsFragmentFragment: FirstSpiritGoogleMapsFragmentFragment;
                  };
                })
              | { __typename: "FirstSpiritInteractiveImage" }
              | { __typename: "FirstSpiritInteractiveImageLink" }
              ...
              | ({ __typename: "FirstSpiritNewsOverview" } & {
                  " $fragmentRefs"?: {
                    FirstSpiritNewsOverviewFragmentFragment: FirstSpiritNewsOverviewFragmentFragment;
                  };
                })
              | ({ __typename: "FirstSpiritProductCategoryTeaser" } & {
                  " $fragmentRefs"?: {
                    FirstSpiritProductCategoryTeaserFragmentFragment: FirstSpiritProductCategoryTeaserFragmentFragment;
                  };
                })
              | { __typename: "FirstSpiritRedirect" }
              | { __typename: "FirstSpiritRequests" }
              ...
              | ({ __typename: "FirstSpiritStage" } & {
                  " $fragmentRefs"?: {
                    FirstSpiritStageFragmentFragment: FirstSpiritStageFragmentFragment;
                  };
                })
              | ({ __typename: "FirstSpiritSteps" } & {
                  " $fragmentRefs"?: {
                    FirstSpiritStepsFragmentFragment: FirstSpiritStepsFragmentFragment;
                  };
                })
              | { __typename: "FirstSpiritStepsItem" }
              | ({ __typename: "FirstSpiritTable" } & {
                  " $fragmentRefs"?: {
                    FirstSpiritTableFragmentFragment: FirstSpiritTableFragmentFragment;
                  };
                })
              | { __typename: "FirstSpiritTask" }
              | ({ __typename: "FirstSpiritTeaser" } & {
                  " $fragmentRefs"?: {
                    FirstSpiritTeaserFragmentFragment: FirstSpiritTeaserFragmentFragment;
                  };
                })
              | ({ __typename: "FirstSpiritTextImage" } & {
                  " $fragmentRefs"?: {
                    FirstSpiritTextImageFragmentFragment: FirstSpiritTextImageFragmentFragment;
                  };
                });
          }
      > | null;
...
export type SectionByTypeQuery = {
  __typename?: "Query";
  allFirstSpiritSection: {
    __typename?: "FirstSpiritSectionConnection";
    nodes: Array<{
  ...
  definitions: [
    {
      ...
      name: { kind: "Name", value: "FirstSpiritTeaserFragment" },
      typeCondition: { kind: "NamedType", name: { kind: "Name", value: "FirstSpiritTeaser" } },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          { kind: "Field", name: { kind: "Name", value: "stHeadline" } },
          { kind: "Field", name: { kind: "Name", value: "stText" } },
          {
            kind: "Field",
            name: { kind: "Name", value: "stImage" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "__typename" } },
                {
                  ...
                  typeCondition: {
                    kind: "NamedType",
                    name: { kind: "Name", value: "FirstSpiritImage" },
                  },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
          ...
          { kind: "Field", name: { kind: "Name", value: "stImageAltText" } },
          {
            kind: "Field",
            name: { kind: "Name", value: "stLayout" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
...
} as unknown as DocumentNode<FirstSpiritTeaserFragmentFragment, unknown>;
export const FirstSpiritStageFragmentFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "FirstSpiritStageFragment" },
      typeCondition: { kind: "NamedType", name: { kind: "Name", value: "FirstSpiritStage" } },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          { kind: "Field", name: { kind: "Name", value: "stHeadline" } },
          {
            kind: "Field",
            alias: { kind: "Name", value: "stSubHeadlineTextImageStage" },
            name: { kind: "Name", value: "stSubheadline" },
          },
          {
            kind: "Field",
            name: { kind: "Name", value: "stImage" },
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "__typename" } },
                      {
                        ...
                        typeCondition: {
                          kind: "NamedType",
                          name: { kind: "Name", value: "FirstSpiritInternalLink" },
                        },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            { kind: "Field", name: { kind: "Name", value: "ltText" } },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "ltLink" },
                              selectionSet: {
                                kind: "SelectionSet",
                                selections: [
                                  { kind: "Field", name: { kind: "Name", value: "__typename" } },
                                  {
                                    ...
                                    typeCondition: {
                                      kind: "NamedType",
                                      name: { kind: "Name", value: "FirstSpiritPageRef" },
                                    },
                                    selectionSet: {
                                      kind: "SelectionSet",
                                      selections: [
...
} as unknown as DocumentNode<FirstSpiritStageFragmentFragment, unknown>;
export const FirstSpiritTextImageFragmentFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "FirstSpiritTextImageFragment" },
      typeCondition: { kind: "NamedType", name: { kind: "Name", value: "FirstSpiritTextImage" } },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          { kind: "Field", name: { kind: "Name", value: "stHeadline" } },
          {
            kind: "Field",
            alias: { kind: "Name", value: "stSubHeadlineTextImage" },
            name: { kind: "Name", value: "stSubheadline" },
          },
          { kind: "Field", name: { kind: "Name", value: "stText" } },
          {
            kind: "Field",
            name: { kind: "Name", value: "stColumns" },
            selectionSet: {
              kind: "SelectionSet",
...
} as unknown as DocumentNode<FirstSpiritTextImageFragmentFragment, unknown>;
export const FirstSpiritProductCategoryTeaserFragmentFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      ...
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "FirstSpiritProductCategoryTeaser" },
      },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "stTextAlignment" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [{ kind: "Field", name: { kind: "Name", value: "key" } }],
            },
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "stCategoryLink" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                {
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "stCategory" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "key" } },
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            { kind: "Field", name: { kind: "Name", value: "__typename" } },
                            {
                              ...
                              typeCondition: {
                                kind: "NamedType",
                                name: { kind: "Name", value: "FirstSpiritSmartlivingCategory" },
                              },
                              selectionSet: {
                                kind: "SelectionSet",
                                selections: [
                                  { kind: "Field", name: { kind: "Name", value: "ttName" } },
                                  {
                                    kind: "Field",
                                    name: { kind: "Name", value: "items" },
                                    selectionSet: {
                                            ...
                                            selections: [
                                              ...
                                              },
                                              {
                                                ...
                                                typeCondition: {
                                                  ...
                                                  name: {
                                                    kind: "Name",
                                                    value: "FirstSpiritSmartlivingProduct",
                                                  },
                                                },
                                                selectionSet: {
                                                  kind: "SelectionSet",
                                                  selections: [
                                                    {
                                                      kind: "Field",
                                                      name: { kind: "Name", value: "ttName" },
                                                    },
                                                    {
                                                      kind: "Field",
                                                      name: { kind: "Name", value: "ttPrice" },
                                                    },
                                                    {
                                                      kind: "Field",
                                                      name: {
                                                    ...
                                                    },
                                                    {
                                                      ...
                                                      name: {
                                                        kind: "Name",
                                                        value: "ttImageAltText",
                                                      },
                                                    },
                                                    {
                                                      kind: "Field",
                                                      name: { kind: "Name", value: "ttCategories" },
                                                      selectionSet: {
                                                        kind: "SelectionSet",
                                                        selections: [
                                                          {
...
} as unknown as DocumentNode<FirstSpiritProductCategoryTeaserFragmentFragment, unknown>;
export const FirstSpiritStepsFragmentFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "FirstSpiritStepsFragment" },
      typeCondition: { kind: "NamedType", name: { kind: "Name", value: "FirstSpiritSteps" } },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          { kind: "Field", name: { kind: "Name", value: "stHeadline" } },
          { kind: "Field", name: { kind: "Name", value: "stSubline" } },
          { kind: "Field", name: { kind: "Name", value: "stText" } },
          {
            kind: "Field",
            name: { kind: "Name", value: "stSteps" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "__typename" } },
                {
                  ...
                  typeCondition: {
                    kind: "NamedType",
                    name: { kind: "Name", value: "FirstSpiritSection" },
                  },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            { kind: "Field", name: { kind: "Name", value: "__typename" } },
                            {
                              ...
                              typeCondition: {
                                kind: "NamedType",
                                name: { kind: "Name", value: "FirstSpiritStepsItem" },
                              },
                              selectionSet: {
                                kind: "SelectionSet",
                                selections: [
                                  { kind: "Field", name: { kind: "Name", value: "__typename" } },
                                  { kind: "Field", name: { kind: "Name", value: "stTitle" } },
                                  { kind: "Field", name: { kind: "Name", value: "stText" } },
                                ],
                              },
                            },
...
} as unknown as DocumentNode<FirstSpiritStepsFragmentFragment, unknown>;
export const FirstSpiritAccordionFragmentFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "FirstSpiritAccordionFragment" },
      typeCondition: { kind: "NamedType", name: { kind: "Name", value: "FirstSpiritAccordion" } },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          { kind: "Field", name: { kind: "Name", value: "stHeadline" } },
          { kind: "Field", name: { kind: "Name", value: "stSubline" } },
          { kind: "Field", name: { kind: "Name", value: "stInfo" } },
          {
            kind: "Field",
            name: { kind: "Name", value: "stAccordion" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "__typename" } },
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            { kind: "Field", name: { kind: "Name", value: "__typename" } },
                            {
                              ...
                              typeCondition: {
                                kind: "NamedType",
                                name: { kind: "Name", value: "FirstSpiritAccordionItem" },
                              },
                              selectionSet: {
                                kind: "SelectionSet",
                                selections: [
                                  { kind: "Field", name: { kind: "Name", value: "stTitle" } },
                                  { kind: "Field", name: { kind: "Name", value: "stContent" } },
                                ],
                              },
                            },
                          ],
...
} as unknown as DocumentNode<FirstSpiritAccordionFragmentFragment, unknown>;
export const FirstSpiritFeaturesFragmentFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "FirstSpiritFeaturesFragment" },
      typeCondition: { kind: "NamedType", name: { kind: "Name", value: "FirstSpiritFeatures" } },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          { kind: "Field", name: { kind: "Name", value: "stHeadline" } },
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "stFeatures" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "__typename" } },
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            { kind: "Field", name: { kind: "Name", value: "__typename" } },
                            {
                              ...
                              typeCondition: {
                                kind: "NamedType",
                                name: { kind: "Name", value: "FirstSpiritFeature" },
                              },
                              selectionSet: {
                                kind: "SelectionSet",
                                selections: [
                                  ...
                                  {
                                    kind: "Field",
                                    name: { kind: "Name", value: "stImageAltText" },
                                  },
                                  {
                                    kind: "Field",
                                    name: { kind: "Name", value: "stType" },
                                    selectionSet: {
                                      kind: "SelectionSet",
                                      selections: [
                                        { kind: "Field", name: { kind: "Name", value: "key" } },
...
} as unknown as DocumentNode<FirstSpiritFeaturesFragmentFragment, unknown>;
export const FirstSpiritGoogleMapsFragmentFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      ...
      selectionSet: {
        ...
        selections: [
          { kind: "Field", name: { kind: "Name", value: "stHeadline" } },
          { kind: "Field", name: { kind: "Name", value: "stSubheadline" } },
          { kind: "Field", name: { kind: "Name", value: "stInitialZoom" } },
          { kind: "Field", name: { kind: "Name", value: "stInitialLat" } },
          { kind: "Field", name: { kind: "Name", value: "stInitialLong" } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<FirstSpiritGoogleMapsFragmentFragment, unknown>;
  ...
  definitions: [
    {
      ...
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "FirstSpiritNewsOverview" },
      },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "stDataPage" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "__typename" } },
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: "Field", name: { kind: "Name", value: "referenceType" } },
                      {
                        ...
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [{ kind: "Field", name: { kind: "Name", value: "fsId" } }],
                        },
                      },
                    ],
                  },
...
} as unknown as DocumentNode<FirstSpiritNewsOverviewFragmentFragment, unknown>;
export const FirstSpiritSmartLivingNewsFragmentFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "FirstSpiritSmartLivingNewsFragment" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "FirstSpiritSmartlivingNews" },
      },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          { kind: "Field", name: { kind: "Name", value: "ttHeadline" } },
          { kind: "Field", name: { kind: "Name", value: "ttSubheadline" } },
          { kind: "Field", name: { kind: "Name", value: "ttDate" } },
          { kind: "Field", name: { kind: "Name", value: "ttAuthor" } },
          { kind: "Field", name: { kind: "Name", value: "ttTags" } },
          {
            kind: "Field",
            name: { kind: "Name", value: "ttImage" },
            selectionSet: {
          ...
          { kind: "Field", name: { kind: "Name", value: "ttImageAltText" } },
          { kind: "Field", name: { kind: "Name", value: "ttTeaserText" } },
          { kind: "Field", name: { kind: "Name", value: "ttArticleText" } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<FirstSpiritSmartLivingNewsFragmentFragment, unknown>;
  ...
  definitions: [
    {
      ...
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "FirstSpiritSmartlivingLocation" },
      },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          { kind: "Field", name: { kind: "Name", value: "ttName" } },
          { kind: "Field", name: { kind: "Name", value: "ttDescription" } },
          { kind: "Field", name: { kind: "Name", value: "ttLat" } },
          { kind: "Field", name: { kind: "Name", value: "ttLong" } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<FirstSpiritSmartLivingLocationFragmentFragment, unknown>;
export const FirstSpiritTableFragmentFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "FirstSpiritTableFragment" },
      typeCondition: { kind: "NamedType", name: { kind: "Name", value: "FirstSpiritTable" } },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          { kind: "Field", name: { kind: "Name", value: "stHeadline" } },
          { kind: "Field", name: { kind: "Name", value: "stText" } },
          { kind: "Field", name: { kind: "Name", value: "stTable" } },
        ],
      },
    },
  ],
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "datasetsByType" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "locale" } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "allFirstSpiritDataset" },
            arguments: [
              {
                kind: "Argument",
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            },
                            {
                              ...
                              name: {
                                kind: "Name",
                                value: "FirstSpiritSmartLivingLocationFragment",
                              },
                            },
                          ],
                        },
...
} as unknown as DocumentNode<DatasetsByTypeQuery, DatasetsByTypeQueryVariables>;
export const GcaPageByNameDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "gcaPageByName" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "locale" } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "firstSpiritGcaPage" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "_locale" },
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "__typename" } },
                      {
                        ...
                        typeCondition: {
                          kind: "NamedType",
                          name: { kind: "Name", value: "FirstSpiritGcaFooter" },
                        },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            { kind: "Field", name: { kind: "Name", value: "gcCopyright" } },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "gcLinks" },
                              selectionSet: {
                                kind: "SelectionSet",
                                selections: [
                                  {
...
} as unknown as DocumentNode<GcaPageByNameQuery, GcaPageByNameQueryVariables>;
                    ...
                    selections: [
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            { kind: "Field", name: { kind: "Name", value: "seoRoute" } },
                            { kind: "Field", name: { kind: "Name", value: "fsNavItemId" } },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "page" },
                              selectionSet: {
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "structureChildren" },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            {
                                ...
                                selections: [
                                  {
                                    ...
                                    selectionSet: {
                                      ...
                                      selections: [
                                        {
                                          kind: "Field",
                                          name: { kind: "Name", value: "fsNavItemId" },
                                        },
                                        { kind: "Field", name: { kind: "Name", value: "label" } },
                                        {
                                          kind: "Field",
...
} as unknown as DocumentNode<FsNavigationQueryQuery, FsNavigationQueryQueryVariables>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "pageByRoute" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "locale" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "__typename" } },
                      {
                        ...
                        typeCondition: {
                          kind: "NamedType",
                          name: { kind: "Name", value: "FirstSpiritStandard" },
                        },
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [
                            { kind: "Field", name: { kind: "Name", value: "ptHeadline" } },
                            { kind: "Field", name: { kind: "Name", value: "ptSubheadline" } },
                            { kind: "Field", name: { kind: "Name", value: "ptMdImageAltText" } },
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "ptImage" },
                              selectionSet: {
                                kind: "SelectionSet",
                                selections: [
                                  { kind: "Field", name: { kind: "Name", value: "__typename" } },
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "pageBodies" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "name" } },
                                    ...
                                    selectionSet: {
                                      ...
                                      selections: [
                                        ...
                                        },
                                        {
                                          ...
                                          name: {
                                            kind: "Name",
                                            value: "FirstSpiritTeaserFragment",
                                          },
                                        },
                                        {
                                          kind: "FragmentSpread",
                                        ...
                                        },
                                        {
                                          ...
                                          name: {
                                            kind: "Name",
                                            value: "FirstSpiritTextImageFragment",
                                          },
                                        },
                                        {
                                          kind: "FragmentSpread",
                                          name: {
                                            kind: "Name",
                                            value: "FirstSpiritProductCategoryTeaserFragment",
                                          },
                                        },
                                        {
                                          kind: "FragmentSpread",
                                        ...
                                        },
                                        {
                                          ...
                                          name: {
                                            kind: "Name",
                                            value: "FirstSpiritAccordionFragment",
                                          },
                                        },
                                        {
                                          kind: "FragmentSpread",
                                          name: {
                                            kind: "Name",
                                            value: "FirstSpiritFeaturesFragment",
                                          },
                                        },
                                        {
                                          kind: "FragmentSpread",
                                          name: {
                                            kind: "Name",
                                            value: "FirstSpiritGoogleMapsFragment",
                                          },
                                        },
                                        {
                                          kind: "FragmentSpread",
                                        ...
                                        },
                                        {
                                          ...
                                          name: {
                                            kind: "Name",
                                            value: "FirstSpiritNewsOverviewFragment",
                                          },
                                        },
                                      ],
                                    },
...
} as unknown as DocumentNode<PageByRouteQuery, PageByRouteQueryVariables>;
                        ...
                        fields: [
                          {
                            kind: "ObjectField",
                            name: { kind: "Name", value: "eq" },
                            value: { kind: "StringValue", value: "product", block: false },
                          },
                        ],
                      },
                    },
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            { kind: "Field", name: { kind: "Name", value: "__typename" } },
                            {
                              ...
                              typeCondition: {
                                kind: "NamedType",
                                name: { kind: "Name", value: "FirstSpiritSmartlivingProduct" },
                              },
                              selectionSet: {
                                kind: "SelectionSet",
                                selections: [
                                  { kind: "Field", name: { kind: "Name", value: "ttName" } },
                                  { kind: "Field", name: { kind: "Name", value: "ttPrice" } },
                                  { kind: "Field", name: { kind: "Name", value: "ttTeaserText" } },
                                  {
                                    kind: "Field",
                                    name: { kind: "Name", value: "ttImage" },
                                  ...
                                  {
                                    kind: "Field",
                                    name: { kind: "Name", value: "ttImageAltText" },
                                  },
                                  {
                                    kind: "Field",
                                    name: { kind: "Name", value: "ttCategories" },
                                            ...
                                            selections: [
                                              ...
                                              },
                                              {
                                                ...
                                                typeCondition: {
                                                  ...
                                                  name: {
                                                    kind: "Name",
                                                    value: "FirstSpiritSmartlivingCategory",
                                                  },
                                                },
                                                selectionSet: {
                                                  kind: "SelectionSet",
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "firstSpiritDataset" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "_locale" },
...
export const SectionByIdDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "sectionById" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "locale" } },
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "allFirstSpiritSection" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "filter" },
...
} as unknown as DocumentNode<SectionByIdQuery, SectionByIdQueryVariables>;
export const SectionByTypeDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "sectionByType" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "locale" } },
...
} as unknown as DocumentNode<SectionByTypeQuery, SectionByTypeQueryVariables>;
