...
import ProductCategoryTeaser, {
  type ProductCategoryTeaserProps,
} from "@/components/section/ProductCategoryTeaser";
...
const mockCategoryProduct: ProductCategoryTeaserProps["categoryProduct"] = {
  category: {
    type: "category",
    key: "category-key",
    value: "Category Name",
