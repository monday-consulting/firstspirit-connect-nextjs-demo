    ...
    return (
        ...
        >
                        ...
                        <div className="relative h-full w-full">
                            ...
                            >
                                <div className="container mx-auto px-4">
                                    <h1 className="font-heading text-4xl font-bold leading-none text-white md:text-5xl">
                                        {data["pt_headline"]}
                                    </h1>
                                    <p className="sm:text-l mt-12 font-heading leading-tight text-white md:text-xl">
                                        {data["pt_subheadline"]}
                                    </p>
                                </div>
                            </div>
            ...
            {showDev && $isPreviewMode && (
                <DevComponent
                    currentDataMock={undefined}
                    currentPageMock={undefined}
                    content={data}
                />
            )}
        </section>
