            ...
            case "FirstSpiritTextImage":
                return (
                    <TextImage
                        ...
                        twoColumn
                        layout={
                            (section.data.stLayout?.key as TextImageLayout) ||
                            "text-image"
                        }
                        image={{
                            src:
                                (section.data.stImage?.__typename ===
                                    "FirstSpiritImage" &&
                                    section.data.stImage.resolutions?.original
                                        ?.url) ||
                                "",
                ...
                return (
                    <ProductCategoryTeaser
                        category={{
                            ...
                            products:
                                section.data.stCategory?.items?.[0]?.data
                                    .items || [],
                        }}
                        link={getConnectorLink(
                            section.data.stCategoryLink?.data
                        )}
                        headline={section.data.stHeadline || ""}
                        text={{ content: section.data.stText }}
                        teaserTextStart={
                            section.data.stTextAlignment?.key === "left"
                        }
                    />
                );
            ...
            case "FirstSpiritStage": {
                return (
                    <Stage
                        ...
                        cta={
                            section.data.stCta?.data
                                ? getConnectorLink(section.data.stCta.data)
                                : undefined
                        }
                    />
                );
                    ...
                    ?.map((feature) => {
                        if (
                            ...
                            return {
                                ...
                                image: {
                                    src:
                                        (feature.data.stImage?.__typename ===
                                            "FirstSpiritImage" &&
                                            feature.data.stImage.resolutions
                                                ?.original?.url) ||
                                        "",
            ...
            case "FirstSpiritTeaser":
                return (
                    <Teaser
                        ...
                        text={{ content: section.data.stText }}
                        imageStart={
                            (section.data.stLayout?.key || "text-image") ===
                            "text-image"
                        }
                        image={{
                            src:
